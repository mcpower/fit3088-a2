...
export const EARTH_RADIUS_GL = 0.18;
export const EPS = 1e-9;
// How much to scale the satellites by.
export const SATELLITE_SCALE = 200;
...
export const SATELLITE_AMBIENT_SELECTED = [0.8, 0.8, 0.8];

export const ORBIT_COLOR = [0.2, 0.2, 0.2];
export const ORBIT_COLOR_SELECTED = [0.9, 0.9, 0.9];
